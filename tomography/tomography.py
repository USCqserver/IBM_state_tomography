...
import tomography.operator_utils
...
import tomography.utils as ut
import tomography.operator_utils as o_ut
from tomography.operator_utils import QI, QX, QY
from tomography.utils import bitlist_to_int, sample_assignment_probs
...
def _do_tomography(target_program, nsamples, cxn, qubits, max_num_qubits, tomography_class,
    ...
    povm = o_ut.make_diagonal_povm(tomography.operator_utils.POVM_PI_BASIS ** num_qubits, assignment_probs)
